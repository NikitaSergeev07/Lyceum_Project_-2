...
from SETTINGS import BoardPath, ElementPath, TextPath, DataPath, MusicPath, musicPlaying, pelletColor, spriteRatio, \
    square, spriteOffset, width, height, screen, gameBoard, originalGameBoard, ghostGate, ghostsafeArea
